 ...
 */
public class PoseSampleReadCSV {
  ...
  public PoseSampleReadCSV(String name, String className, List<PointF3D> landmarks) {
    this.name = name;
  ...
  public static PoseSampleReadCSV getPoseSample(String csvLine, String separator) {
    ...
    return new PoseSampleReadCSV(name, className, landmarks);
  }
}
