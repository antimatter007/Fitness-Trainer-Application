...
import com.google.mlkit.vision.demo.java.posedetector.ScreenFaceDistance;
...
public class PoseClassifierProcessor {
  ...
  private void loadPoseSamples(Context context) {
    List<PoseSampleReadCSV> poseSamples = new ArrayList<>();
    try {
      ...
      while (csvLine != null) {
        ...
        PoseSampleReadCSV poseSample = PoseSampleReadCSV.getPoseSample(csvLine, ",");
        if (poseSample != null) {
    ...
    //-----------Sending pose samples to the classifier--------------
    poseClassifier = new PoseClassifier(poseSamples);

    //------------Sending the className to the counter---------------
