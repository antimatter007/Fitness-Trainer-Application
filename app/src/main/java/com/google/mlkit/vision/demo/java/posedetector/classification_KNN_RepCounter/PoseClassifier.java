...
package com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter;

import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.PoseEmbedding.getPoseEmbedding;
import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.Utils.maxAbs;
import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.Utils.multiply;
import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.Utils.multiplyAll;
import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.Utils.subtract;
import static com.google.mlkit.vision.demo.java.posedetector.classification_KNN_RepCounter.Utils.sumAbs;
...
/**
 * Classifies {link Pose} based on given {@link PoseSampleReadCSV}s.
 *
...
public class PoseClassifier {
  ...
  private final List<PoseSampleReadCSV> poseSamples;
  private final int maxDistanceTopK;
  private final int meanDistanceTopK;
  private final PointF3D axesWeights;

  public PoseClassifier(List<PoseSampleReadCSV> poseSamples) {
    this(poseSamples, MAX_DISTANCE_TOP_K, MEAN_DISTANCE_TOP_K, AXES_WEIGHTS);
  }

  public PoseClassifier(List<PoseSampleReadCSV> poseSamples, int maxDistanceTopK,
   ...
   *
   * <p><Since we calculate confidence by counting {@link PoseSampleReadCSV}s that survived
  ...
  public ClassificationResult classify(List<PointF3D> landmarks) {
    ...
    PriorityQueue<Pair<PoseSampleReadCSV, Float>> meanDistances = new PriorityQueue<>(
    ...
    for (Pair<PoseSampleReadCSV, Float> sampleDistances : maxDistances) {
      PoseSampleReadCSV poseSample = sampleDistances.first;
      List<PointF3D> sampleEmbedding = poseSample.getEmbedding();
    ...
    for (Pair<PoseSampleReadCSV, Float> sampleDistances : meanDistances) {
